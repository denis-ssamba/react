...
const Task = ()=>{
    ...
    const handleTaskSubmission = async (event)=>{
        ...
        if(!getPrevioustasks){  // intially when key doesn't exist. 
...
return ( <div>
    {/*<h1>Task lists</h1>*/}
    {error && <h1 style={{color:'red'}}>{error} contact support or reload the page</h1>}
    {
        loading ? <div className="loader" ><img  src={loadingImg} alt="loading symbol" /> </div>:
